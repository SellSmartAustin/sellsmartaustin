...
3. LLC & Legal
4. Tech Stack
5. Lead Gen Strategy — Facebook Ads
6. Content Strategy
...
### What Sell Smart Austin Is

Sell Smart Austin is James Konvalinka's seller lead generation and acquisition platform in the Austin, TX market. The brand is seller-facing and designed to attract motivated homeowners who want a fast, simple exit from their property.
...
- **Landlords** — tired of chasing rent, dealing with tenants, watching property taxes climb
- **Frustrated listers** — home sitting on the market with no results
- **Financial pressure** — behind on mortgage, can't afford repairs, need out fast
- **Life events** — divorce, death in family, relocation, inherited property

### One-Sentence Pitch (Seller-Facing)

"I make it simple, so you can sell smart."

### James's Role

Licensed TX agent under MODUS Real Estate. All outreach signed: **"James K | MODUS Real Estate | Licensed TX Agent"**

---

## 2. Brand Identity

**Brand Name:** Sell Smart Austin
...
| Asset | File |
|---|---|
| Logo (SVG) | `/brand/logo-v3.svg` |
| Logo Icon (SVG) | `/brand/logo-icon.svg` |
...
- **Inbound only** — FB ads + direct mail
- **NO cold SMS outreach** (legal risk, James's preference)
- FB Campaign: Special Ad Category Housing | Leads objective | $25/day | Austin 25mi radius | Broad targeting
- Phase 1 (weeks 1-4): Ad 1 only — let FB exit learning phase (50+ conversions needed before rotating)
- Rotate creative every 4-6 weeks OR when CPL jumps 30%+
...
**Flip Reveal Captions** (Before/During/After albums)
Script file: `/FLIP_CAPTIONS.md`

Key hooks that work:
- Specific numbers (bought for $X, sold for $Y)
...
- First person, past tense storytelling
- Specific details — neighborhood, one real challenge, one real decision
- No buzzwords: "motivated sellers," "we buy ugly houses," "any condition" = instant unfollow
- Low-friction CTA — conversational, not pushy

---

## 7. CRM & Automation — Resimpli

**Switched from REI BlackBook to Resimpli** (April 2026)

**Why:** AI call answering, speed-to-lead, built-in skip tracing, better automation — objectively stronger platform for solo operator.
